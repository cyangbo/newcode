...
function createOrderAction(){
 ...
 function getTrackingAction($smCode,$trackingNumber){
 	...
 	$HeaderRequest['customerCode'] = 'C0148';
 	$HeaderRequest['appToken'] = '157AD0B4D99711FB';
 	$HeaderRequest['appKey'] = '5a52d9d3b616e44d3a5ad15332516380';
...
$smCode = 'SF';
 	...
 	//$wsdlurl = "http://yoms.com/default/order-soap";
 	$wsdlurl = "http://bc-import.ehaiwaigou.cn/default/order-soap";
...
function getOrderByCodeAction(){	
	...
	$params['orderCode'] = 'SOC00890001235';
	
	$url = 'http://bc-testimport.ehaiwaigou.cn/default/order-soap';
	$client = new SoapClient($url,array( 'trace' => 1 ));
	try{
