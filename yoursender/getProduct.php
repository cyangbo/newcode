...
function createOrderAction(){
    $HeaderRequest['customerCode'] = 'C0137';
	$HeaderRequest['appToken'] = '21CADC285CB50F68';
	$HeaderRequest['appKey'] = '8710c8e663aa9e603359cc60eb6b7828';	
	...
	$paragram['OrderInfo'] = array(
            ...
            'referenceNo'       => '99201501253655',
            'trackingNumber'    => '9898000011155',
            'grossWt'           => 40,
            'currencyCode'      => 'RMB',
            'orderProduct'     => array(
                array(
                    'productSku'        => 'scc20150327',
                    'opQuantity'        => 2,
                    'dealPrice'         => 35.5,
                    'transactionPrice'  => 71,
                ),
