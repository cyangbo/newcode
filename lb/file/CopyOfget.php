...
<div>
	<form method="post" name="text" action="get.php?action=cc">
		<dl>
			<dt></dt>
			<dd>输入:文件所在目录<input type="text" name="username" class="text" />例如:D:\wamp\www\test</dd>
			<dd>输入:文件要保存的目录<input type="password" name="password" class="text" />例如:D:\wamp\www\save</dd>
			<dd>保　　留：<input type="radio" name="time" value="0" /> 不保留 <input type="radio" name="time" value="1" checked="checked" /> 一天 <input type="radio" name="time" value="2" /> 一周 <input type="radio" name="time" value="3" /> 一月</dd>
